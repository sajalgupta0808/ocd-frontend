...
const HomePage = () => {
    ...
    return (
        <div className="mx-auto">
            ...
            <section className='text-app-white relative min-h-screen overflow-hidden'>
                ...
                <div>
                   <p
                    className="font-semibold text-md text-center mt-4 xl:mt-3"
                    style={{ color: "#FFFFFF" }}
                    >
  ...
  <button className="bg-custom-red border-custom-red text-white font-bold px-8 py-2 text-lg border-2 rounded-md
                     hover:bg-yellow-600 hover:text-white hover:shadow-lg hover:shadow-yellow-600/70 transition-all duration-300">
            ...
            <section className='text-white px-4 py-16'>
                <div className='flex items-center justify-around  gap-10 '>
                    <div className='flex flex-col gap-4 max-w-2xl h-[600px'>
                        ...
                        <h1 className='font-bebas text-2xl font-light pt-4 text-app-white mb-4'>Every Surface. Every Curve. Every Inch. Perfected.</h1>
