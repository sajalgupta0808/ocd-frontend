      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 h-auto w-full ">
        ...
        >
          ...
          <div className="relative z-10 max-w-lg text-center">
            ...
            <button
              className="bg-custom-red border-custom-red text-white rounded-md hover:bg-red-700 transition-colors min-w-[150px] flex items-center justify-center border-2"
            ...
            <button
              className="bg-custom-red border-custom-red text-white rounded-md hover:bg-red-700 transition-colors min-w-[150px] flex items-center justify-center gap-2 border-2"
              style={{ fontFamily: 'Inter', padding: '8px 16px', fontSize: '14px' }} // reduced font size
            >
        ...
        >
          ...
          <div className="relative z-10 max-w-lg text-center">
            ...
            <div className="mb-8 flex justify-center">
             <button
              className="bg-custom-red border-custom-red text-white rounded-md hover:bg-red-700 transition-colors min-w-[200px] flex items-center justify-center border-2"
              style={{
