...
const Hero = () => {
  return (
    <div className="flex flex-col items-center justify-center text-app-white py-16">
      <h1 className="font-bebas text-3xl sm:text-4xl md:text-5xl lg:text-6xl pt-28 text-app-white text-center">
